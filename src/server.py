...
@server.tool(
    ...
    description=(
        ...
        "YouTube rate-limits translated captions far more aggressively than "
        "ordinary ones, so asking for a language the video has no real caption "
        "track in fails fairly often. The error then lists the languages that do "
        "have real tracks — prefer one of those, or drop target_language, rather "
